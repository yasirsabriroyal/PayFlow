...
export default function AddContractorPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    email: '',
    phone: '',
    vendor_type: 'contractor' as 'contractor' | 'supplier' | 'both',
    trade: '',
    trade_subcategory: '',
    address_line1: '',
    city: '',
          ...
          <div className="bg-card border border-border rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2 space-y-2">
                ...
                >
                  <SelectTrigger id="vendor_type" className="h-11">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="contractor">Contractor — has portal access, submits own invoices</SelectItem>
                    <SelectItem value="supplier">Supplier — no portal, invoices generated by recurring schedules</SelectItem>
                    <SelectItem value="both">Both — has portal access and appears in recurring expense templates</SelectItem>
                  </SelectContent>
                </Select>
                <p className="text-xs text-muted-foreground">
                  Suppliers are used as vendors in recurring expense templates (e.g. rent, utilities). Contractors submit their own invoices via the portal.
                </p>
              </div>
